...
;;k-only plot
k_print, filename='modelselection_kgcs.ps'
djs_plot, ks, logliketwo[*,1], xrange=xrange,$
  xtitle='K',ytitle='log likelihood'
k_end_print
;;k-only plot
k_print, filename='modelselection_kgcs_zoom.ps'
djs_plot, ks, logliketwo[*,1], xrange=[5,13],$
  xtitle='K',ytitle='log likelihood'
k_end_print
END

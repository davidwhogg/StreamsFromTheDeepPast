...
;      bimodality_scalar
;   PURPOSE:
;      calculate a scalar that indicates how bimodal a distribution is
;   CALLING SEQUENCE:
;      bimodality_scalar(data,kindx=kindx)
;   INPUT:
;      data    - samples from a distribution
;   OUTPUT:
;      the scalar - kmeans_var[2]/var
;      kindx      - array specifying for each point whether it is
;                   associated with the smallest or the largest K-mean
;   REVISION HISTORY;
;      Somewhere in 2008 - Written - Hogg
;      2009-02-17 - This header written, tested - Bovy
;-
